# Main
Habit tracker using object-oriented and functional programming in Python.
...
o The habits users enter in the app are not only stored but can also be analysed. Users want answers to several questions like: 
what’s my longest habit streak? What's the list of my current daily habits? With which habits did I struggle most last month?
